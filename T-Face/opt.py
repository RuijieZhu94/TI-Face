...
def config_parser(cmd=None):
    ...
    parser.add_argument('--dataset_name', type=str, default='blender',
                        choices=['blender', 'llff', 'nsvf', 'dtu','tankstemple','ILSH', 'ILSH_RGBA', 'own_data'])
    ...
    parser.add_argument("--TV_weight_app", type=float, default=0.0,
                        help='loss weight')
    parser.add_argument("--acc_loss", type=float, default=0.0,
                        help='loss weight')    
    parser.add_argument("--opa_loss", type=float, default=0.0,
                        help='loss weight')
    parser.add_argument("--vgg_loss", type=float, default=0.0,
                        help='loss weight')         
    # model
    # volume options
