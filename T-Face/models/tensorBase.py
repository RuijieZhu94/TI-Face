...
class TensorBase(torch.nn.Module):
    ...
    @torch.no_grad()
    def filtering_rays(self, all_rays, all_rgbs, all_masks=None, N_samples=256, chunk=10240*5, bbox_only=False):
        ...
        if all_masks is None:
            ...
            return all_rays[mask_filtered], all_rgbs[mask_filtered], all_masks[mask_filtered]
    ...
    def forward(self, rays_chunk, white_bg=True, is_train=False, ndc_ray=False, N_samples=-1):
        ...
        return rgb_map, depth_map, acc_map # rgb, sigma, alpha, weight, bg_weight
