...
class NeuSSystem(BaseSystem):
    ...
    def preprocess_data(self, batch, stage):
        ...
        if stage in ['train']:
            ...
            valid_mask = self.dataset.all_valids[index, y, x].view(-1).bool().to(self.rank)
        else:
            ...
            valid_mask = self.dataset.all_valids[index].view(-1).bool().to(self.rank)            
    ...
    def training_step(self, batch, batch_idx):
        ...
        # loss_mask = F.mse_loss(opacity, batch['fg_mask'].float())        
